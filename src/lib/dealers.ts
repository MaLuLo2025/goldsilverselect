...
export const dealers: Dealer[] = [
  ...
  // ============================================================
  {
    ...
    vertical: "local-coin-bullion",
    description:
      "Colorado\u2019s largest precious metals dealer. In business since 1976 with two locations in Denver and Greenwood Village. Buys and sells gold, silver, and platinum coins, bars, rare coins, paper money, and collectibles. High inventory turnover ensures regularly updated selection.",
  ...
  },
  {
    ...
    vertical: "online-coin-bullion",
    description:
      "Virginia-based online precious metals dealer founded in 2014. Carries specialty and limited-edition releases alongside standard bullion products. Posts premiums on all products. Free shipping on orders over $199. Maintains a buyback program. Accepts multiple payment methods including cryptocurrency.",
    city: "Fauquier County",
    citySlug: "fauquier-county",
    state: "Virginia",
    stateSlug: "virginia",
  ...
  },
  {
    ...
    vertical: "online-coin-bullion",
    description:
      "Austin-based online precious metals dealer founded in 2017. Operates with a curated product catalog rather than an exhaustive inventory, focused on popular gold and silver bullion coins, bars, and rounds. Free insured shipping on orders over $149. No phone solicitation. Posts all premiums transparently on the website.",
    city: "Austin",
    citySlug: "austin",
    state: "Texas",
    stateSlug: "texas",
  ...
  },
  {
    ...
    vertical: "online-coin-bullion",
    description:
      "Long-established coin dealer founded in 1985, offering both bullion and numismatic products online. Carries gold and silver coins, bars, and rounds alongside collectible and certified coins.",
